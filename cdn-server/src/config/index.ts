...
const configSchema = z.object({
  ...
  ALLOWED_ORIGINS: z.string().default('http://localhost:4500,http://localhost:5173'),
...
function loadConfig() {
  const env = {
    ...
    MAX_CACHE_SIZE: process.env.MAX_CACHE_SIZE ? parseInt(process.env.MAX_CACHE_SIZE) : undefined,
