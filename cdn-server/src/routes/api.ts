...
export async function apiRoutes(fastify: FastifyInstance) {
  fastify.post('/preload', { preHandler: requireAuth }, async (request: AuthenticatedRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post<{ Params: CIDParams }>('/pin/:cid', { preHandler: requireAuth }, async (request: AuthenticatedRequest<{ Params: CIDParams }>, reply: FastifyReply) => {
    const { cid } = request.params;
  ...
  fastify.delete<{ Params: CIDParams }>('/pin/:cid', { preHandler: requireAuth }, async (request: AuthenticatedRequest<{ Params: CIDParams }>, reply: FastifyReply) => {
    const { cid } = request.params;
  ...
  fastify.post('/cache/clear', { preHandler: requireAuth }, async (request: AuthenticatedRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.delete<{ Params: CIDParams }>('/cache/:cid', { preHandler: requireAuth }, async (request: AuthenticatedRequest<{ Params: CIDParams }>, reply: FastifyReply) => {
    const { cid } = request.params;
  ...
  fastify.post('/cache/invalidate', { preHandler: requireAuth }, async (request: AuthenticatedRequest, reply: FastifyReply) => {
    try {
      ...
      const successful = results
        .filter((result): result is PromiseFulfilledResult<{ cid: string; status: string }> => 
  ...
  fastify.post('/webhook/cache-invalidate', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
