...
import { WALRUS_ENDPOINTS, type WalrusNetwork } from '../config/walrus-endpoints.js';
...
class EndpointHealthService {
  ...
  private logHealthStatus(): void {
    ...
    console.log(`   Aggregators: ${status.aggregators.healthy}/${status.aggregators.total} healthy`);
    console.log(`   Publishers: ${status.publishers.healthy}/${status.publishers.total} healthy`);
