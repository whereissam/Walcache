...
describe('getWalrusCDNUrl - Multi-Chain CDN URL Generation', () => {
  ...
  describe('🌐 Chain Support Utilities', () => {
    ...
    test('should get primary endpoint for each chain', () => {
      expect(getChainEndpoint('sui')).toBe('https://aggregator.walrus-testnet.walrus.space');
      expect(getChainEndpoint('ethereum')).toBe('https://eth-aggregator.walrus.space');
      expect(getChainEndpoint('solana')).toBe('https://sol-aggregator.walrus.space');
    });
  });
