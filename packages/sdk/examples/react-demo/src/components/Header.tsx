...
import { Database, Rocket, Shield } from 'lucide-react'
  ...
  return (
    <header className="text-center text-white mb-10">
      ...
      <div className="mt-6 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4 max-w-2xl mx-auto">
        <p className="text-sm">
          <strong>💡 Architecture:</strong> Your React app calls your backend
          API → Your backend uses Walcache SDK → SDK handles all blockchain
          complexity
        </p>
      </div>
    </header>
