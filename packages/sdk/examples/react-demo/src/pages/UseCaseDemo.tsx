...
const siteUrl = await sdk.getSiteUrl({ 
  ...
  },
  {
    ...
    description:
      'Sell access to datasets with NFT/token gating and monetization',
    features: [
...
if (await sdk.verifyAccess({ user: '0x123...', fileId })) {
  ...
  },
  {
    ...
    title: 'Gaming Assets',
    description:
      'User-generated content with ownership, trading, and cross-game compatibility',
    features: [
...
const { document } = await sdk.resolveDID('did:sui:0x123...')`,
  },
  {
    ...
    description:
      'Audit trails and proofs for smart contracts across multiple blockchains',
    features: [
...
const { referenceHash } = await sdk.getLogReference(logId)`,
  },
  {
    ...
    description:
      'Gated content with NFT/token access control and premium experiences',
    features: [
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-white opacity-90 mb-6 max-w-3xl mx-auto">
          Explore how developers are using Walcache SDK to build production
          applications across multiple blockchains with a single, unified
          interface.
        </p>
      </div>
          ...
          return (
            <div key={index} className="card p-6">
              <div className="flex items-start gap-4 mb-6">
                <div
                  className={`w-12 h-12 bg-gradient-to-r ${useCase.color} rounded-lg flex items-center justify-center flex-shrink-0`}
                >
        ...
        <div className="bg-white p-6 rounded-lg border border-blue-200">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm text-blue-700">
            <div>
              <ul className="space-y-2">
                <li>
                  • <strong>Security:</strong> Private keys stay on your backend
                </li>
                <li>
                  • <strong>Performance:</strong> Backend caching and
                  optimization
                </li>
                <li>
                  • <strong>Flexibility:</strong> Easy to modify business logic
                </li>
              </ul>
            </div>
            <div>
              <ul className="space-y-2">
                <li>
                  • <strong>Scalability:</strong> Handle multiple users
                  efficiently
                </li>
                <li>
                  • <strong>Reliability:</strong> Error handling and retry logic
                </li>
                <li>
                  • <strong>Compliance:</strong> Centralized policy enforcement
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="card p-8 text-center">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          Start building your multi-chain application today. The SDK handles all
          the blockchain complexity while you focus on your business logic and
          user experience.
        </p>
        <div className="flex justify-center gap-4">
          ...
          <button className="btn-secondary">Download SDK</button>
        </div>
      </div>
    </div>
  )
