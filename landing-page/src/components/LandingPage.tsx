    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle, ${BRAND_COLORS.primary}, transparent 70%)`,
          }}
        ></div>
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle, ${BRAND_COLORS.secondary}, transparent 70%)`,
          }}
        ></div>
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle, ${BRAND_COLORS.accent}, transparent 70%)`,
          }}
        ></div>
      </div>
            ...
            <div className="nav-launch">
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(45deg, ${BRAND_COLORS.primaryDark}, ${BRAND_COLORS.secondaryDark})`,
                  }}
                ></div>
              </Button>
            </div>
      ...
      <section
        ...
        style={{ backgroundColor: BRAND_COLORS.dark, minHeight: '600px' }}
      >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div
                ...
                style={{
                  background: `linear-gradient(45deg, ${BRAND_COLORS.primary}, ${BRAND_COLORS.primaryLight})`,
                }}
              >
              ...
              <p
                ...
                style={{ color: '#E2E8F0' }}
              >
                Intelligent caching system delivers content at blazing speeds
                with Redis-powered optimization.
              </p>
            </div>
            ...
            >
              <div
                className="feature-icon w-16 h-16 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 hover:rotate-12"
                style={{
                  background: `linear-gradient(45deg, ${BRAND_COLORS.accent}, ${BRAND_COLORS.primary})`,
                }}
              >
              ...
              <p
                ...
                style={{ color: '#E2E8F0' }}
              >
                Built on Walrus network for maximum security and censorship
                resistance.
              </p>
            </div>
            ...
            >
              <div
                className="feature-icon w-16 h-16 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 hover:rotate-12"
                style={{
                  background: `linear-gradient(45deg, ${BRAND_COLORS.secondary}, ${BRAND_COLORS.secondaryLight})`,
                }}
              >
              ...
              <p
                ...
                style={{ color: '#E2E8F0' }}
              >
                Multi-chain support with automatic failover and health
                monitoring.
              </p>
            </div>
          </div>
      ...
      <section
        ...
        style={{ backgroundColor: `${BRAND_COLORS.dark}30` }}
      >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="cta-section">
            ...
            <p
              ...
              style={{ color: BRAND_COLORS.textMuted }}
            >
              Join the next generation of decentralized content delivery with
              Walcache
            </p>
            <Button
              size="lg"
